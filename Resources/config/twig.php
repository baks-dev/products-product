...
return static function (TwigConfig $config, ContainerConfigurator $configurator)
{
	...
	$configurator->parameters()->set(ProductPhoto::TABLE, '%kernel.project_dir%/public/upload/'.ProductPhoto::TABLE.'/');
	...
	$configurator->parameters()->set(ProductFiles::TABLE, '%kernel.project_dir%/public/upload/'.ProductFiles::TABLE.'/');
	...
	$configurator->parameters()->set(ProductVideo::TABLE, '%kernel.project_dir%/public/upload/'.ProductVideo::TABLE.'/');
